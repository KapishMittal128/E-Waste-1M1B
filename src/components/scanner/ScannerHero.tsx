          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  ...
                  <div className="text-[11px] text-zinc-600 font-normal">Use live phone camera</div>
                </div>
              </div>
            ...
            >
              ...
              <div className="text-left">
                ...
                <div className="text-[11px] text-zinc-400 font-normal">Select image from gallery</div>
              </div>
            </Button>
          </div>
